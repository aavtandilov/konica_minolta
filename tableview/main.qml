        ...
        Button {
            ...
            Message {
                ...
                onXmlActivated: {
                    ...
                    entry = {
                        URL: fileDialog.fileUrls.toString()
                    } // invokes Message::setentry()
                    for (var i = 0; i < sourceModel.count; i++) {
                        if (sourceModel.get(i).bool) {
                            var readySend = {
                                idnumber: sourceModel.get(i).idnumber,
    ...
    TableView {
        ...
        FocusScope {
            ...
            CheckBox {
                ...
                Component.onCompleted: window.setAllCheckboxes.connect(
                                           setAllCheckboxesLocal)
        ...
        TableViewColumn {
            ...
            delegate: CheckBox {
                ...
                onVisibleChanged: if (visible)
                                      checked = sourceModel.get(
                                                  styleData.row).bool
                onCheckedChanged: console.log(
                                      "onCheckedChanged" + styleData.row)
                onActivated: {
                    checked = sourceModel.get(styleData.row).bool
        ...
        model: SortFilterProxyModel {
            ...
            sortRole: sourceModel.count > 0 ? tableView.getColumn(
                                                  tableView.sortIndicatorColumn).role : ""
